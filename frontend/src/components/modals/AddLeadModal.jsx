      ...
      <div className="relative w-full max-w-lg glass-panel p-6 rounded-2xl border border-brand-400/50 shadow-glow bg-slate-900/95 space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold text-white">Capture Inbound Lead</h2>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            <label className="text-xs font-semibold text-slate-300 block mb-1">Lead Ingestion Source</label>
            <select
